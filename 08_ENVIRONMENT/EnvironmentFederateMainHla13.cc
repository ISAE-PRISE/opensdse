...
int main(int argc, char *argv[])
{
	...
	std::wstring FederationName = EnvironmentFederateHla13::getWString(federationName.c_str());
	std::wstring FederateName = EnvironmentFederateHla13::getWString(federateName.c_str());
	std::wstring FomFile = EnvironmentFederateHla13::getWString(fomFile.c_str());
	...
	EnvironmentFederateHla13 myFederate(FederationName, FederateName, FomFile);
