...
int main(int argc, char *argv[])
{
	...
	string federateName   =  getFederateName(params, "ENVIRONMENT");
	...
	wcout << L"***************************************************" << endl;
    wcout << L"" << endl;
	wcout << L"OpenSDSE Federate " << EnvironmentFederateHla1516e::getWString(federateName.c_str()) << " is started" << endl;
	...
	std::wstring FederationName = EnvironmentFederateHla1516e::getWString(federationName.c_str());
	std::wstring FederateName = EnvironmentFederateHla1516e::getWString(federateName.c_str());
	std::wstring FomFile = EnvironmentFederateHla1516e::getWString(fomFile.c_str());
	...
	EnvironmentFederateHla1516e myFederate(FederationName, FederateName, FomFile);
