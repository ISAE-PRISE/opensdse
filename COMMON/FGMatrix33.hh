/**
 * @file
 * @brief Define the FGMatrix33 class.
 * This class comes from the FlightGear simulator 
 * and this is also used in JsBSim Library.
 * @addtogroup Common
 * @{
 */
...
#ifndef FGMATRIX33_HH
#define FGMATRIX33_HH
...
*/
class MatrixException : public UnitConversion
{
public:
  string Message;
};
...
*/
class FGMatrix33 : public UnitConversion
{
public:
