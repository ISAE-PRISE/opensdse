...
int main(int argc, char *argv[])
{
	...
	std::wstring FederationName = DataLoggerFederateHla13::getWString(federationName.c_str());
	std::wstring FederateName = DataLoggerFederateHla13::getWString(federateName.c_str());
	std::wstring FomFile = DataLoggerFederateHla13::getWString(fomFile.c_str());
	...
	DataLoggerFederateHla13 myFederate(FederationName, FederateName, FomFile);
