...
int main(int argc, char *argv[])
{
	...
	string federateName   =  getFederateName(params, "DATA_LOGGER");
	...
	wcout << L"***************************************************" << endl;
    wcout << L"" << endl;
	wcout << L"OpenSDSE Federate " << DataLoggerFederateHla1516e::getWString(federateName.c_str()) << " is started" << endl;
	...
	std::wstring FederationName = DataLoggerFederateHla1516e::getWString(federationName.c_str());
	std::wstring FederateName = DataLoggerFederateHla1516e::getWString(federateName.c_str());
	std::wstring FomFile = DataLoggerFederateHla1516e::getWString(fomFile.c_str());
	...
	DataLoggerFederateHla1516e myFederate(FederationName, FederateName, FomFile);
