...
// This federate communicates with the federation
// and takes care of aircraft's engines simulation.
int main(int argc, char *argv[])
{
	...
	string federateName   =  getFederateName(params, "ENGINES");
	...
	wcout << L"***************************************************" << endl;
    wcout << L"" << endl;
	wcout << L"OpenSDSE Federate " << EnginesFederateHla1516e::getWString(federateName.c_str()) << " is started" << endl;
	...
	std::wstring FederationName = EnginesFederateHla1516e::getWString(federationName.c_str());
	std::wstring FederateName = EnginesFederateHla1516e::getWString(federateName.c_str());
	std::wstring FomFile = EnginesFederateHla1516e::getWString(fomFile.c_str());
	...
	EnginesFederateHla1516e myFederate(FederationName, FederateName, FomFile);
