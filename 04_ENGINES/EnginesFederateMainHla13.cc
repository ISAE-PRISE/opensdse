...
int main(int argc, char *argv[])
{
	...
	std::wstring FederationName = EnginesFederateHla13::getWString(federationName.c_str());
	std::wstring FederateName = EnginesFederateHla13::getWString(federateName.c_str());
	std::wstring FomFile = EnginesFederateHla13::getWString(fomFile.c_str());
	...
	EnginesFederateHla13 myFederate(FederationName, FederateName, FomFile);
