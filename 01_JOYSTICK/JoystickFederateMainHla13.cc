...
int main(int argc, char *argv[])
{
	...
	std::wstring FederationName = JoystickFederateHla13::getWString(federationName.c_str());
	std::wstring FederateName = JoystickFederateHla13::getWString(federateName.c_str());
	std::wstring FomFile = JoystickFederateHla13::getWString(fomFile.c_str());
	...
	JoystickFederateHla13 myFederate(FederationName, FederateName, FomFile);
