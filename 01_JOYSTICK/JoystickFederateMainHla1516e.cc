...
int main(int argc, char *argv[])
{
	...
	string federateName   =  getFederateName(params, "JOYSTICK");
	...
	wcout << L"***************************************************" << endl;
    wcout << L"" << endl;
	wcout << L"OpenSDSE Federate " << JoystickFederateHla1516e::getWString(federateName.c_str()) << " is started" << endl;
	...
	std::wstring FederationName = JoystickFederateHla1516e::getWString(federationName.c_str());
	std::wstring FederateName = JoystickFederateHla1516e::getWString(federateName.c_str());
	std::wstring FomFile = JoystickFederateHla1516e::getWString(fomFile.c_str());
	...
	JoystickFederateHla1516e myFederate(FederationName, FederateName, FomFile);
