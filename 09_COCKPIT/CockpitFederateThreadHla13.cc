...
//  Link with Qt Window
CockpitMainWindow *CockpitFederateThreadHla13::window;
CockpitFederateThreadHla13::CockpitFederateThreadHla13(CockpitMainWindow *_window)
{    
  CockpitFederateThreadHla13::window =_window;
}

void CockpitFederateThreadHla13::run()
{
	...
	std::wstring FederationName = CockpitFederateHla13::getWString(federationName.c_str());
	std::wstring FederateName = CockpitFederateHla13::getWString(federateName.c_str());
	std::wstring FomFile = CockpitFederateHla13::getWString(fomFile.c_str());
	...
	CockpitFederateHla13 myFederate(FederationName, FederateName, FomFile);
