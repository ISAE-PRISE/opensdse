...
int main(int argc, char *argv[])
{
	...
	string federateName   =  getFederateName(params, "SENSORS");
	...
	wcout << L"***************************************************" << endl;
    wcout << L"" << endl;
	wcout << L"OpenSDSE Federate " << SensorsFederateHla1516e::getWString(federateName.c_str()) << " is started" << endl;
	...
	std::wstring FederationName = SensorsFederateHla1516e::getWString(federationName.c_str());
	std::wstring FederateName = SensorsFederateHla1516e::getWString(federateName.c_str());
	std::wstring FomFile = SensorsFederateHla1516e::getWString(fomFile.c_str());
	...
	SensorsFederateHla1516e myFederate(FederationName, FederateName, FomFile);
