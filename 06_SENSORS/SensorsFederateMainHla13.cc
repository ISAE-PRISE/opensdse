...
int main(int argc, char *argv[])
{
	...
	std::wstring FederationName = SensorsFederateHla13::getWString(federationName.c_str());
	std::wstring FederateName = SensorsFederateHla13::getWString(federateName.c_str());
	std::wstring FomFile = SensorsFederateHla13::getWString(fomFile.c_str());
	...
	SensorsFederateHla13 myFederate(FederationName, FederateName, FomFile);
