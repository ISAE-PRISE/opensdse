...
int main(int argc, char *argv[])
{
	...
	std::wstring FederationName = EfcsFederateHla13::getWString(federationName.c_str());
	std::wstring FederateName = EfcsFederateHla13::getWString(federateName.c_str());
	std::wstring FomFile = EfcsFederateHla13::getWString(fomFile.c_str());
	...
	EfcsFederateHla13 myFederate(FederationName, FederateName, FomFile);
