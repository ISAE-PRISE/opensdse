...
// This federate communicates with the federation and 
// takes care of aircraft's control surfaces simulation (Elevator, Aileron, Rudder, ...).
int main(int argc, char *argv[])
{
	...
	string federateName   =  getFederateName(params, "CONTROL_SURFACES");
	...
	wcout << L"***************************************************" << endl;
    wcout << L"" << endl;
	wcout << L"OpenSDSE Federate " << ControlSurfacesFederateHla1516e::getWString(federateName.c_str()) << " is started" << endl;
	...
	std::wstring FederationName = ControlSurfacesFederateHla1516e::getWString(federationName.c_str());
	std::wstring FederateName = ControlSurfacesFederateHla1516e::getWString(federateName.c_str());
	std::wstring FomFile = ControlSurfacesFederateHla1516e::getWString(fomFile.c_str());
	...
	ControlSurfacesFederateHla1516e myFederate(FederationName, FederateName, FomFile);
	...
	// HLA tm settings
	myFederate.setHlaTimeManagementSettings( 10.0 // Timestep
                                           , 3.0 // Lookahead
                                           , 0.0 // LocalTime
