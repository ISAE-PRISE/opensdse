...
int main(int argc, char *argv[])
{
	...
	std::wstring FederationName = ControlSurfacesFederateHla13::getWString(federationName.c_str());
	std::wstring FederateName = ControlSurfacesFederateHla13::getWString(federateName.c_str());
	std::wstring FomFile = ControlSurfacesFederateHla13::getWString(fomFile.c_str());
	...
	ControlSurfacesFederateHla13 myFederate(FederationName, FederateName, FomFile);
