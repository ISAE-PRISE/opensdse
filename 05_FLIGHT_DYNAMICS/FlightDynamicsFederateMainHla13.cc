...
int main(int argc, char *argv[])
{
	...
	string federateName   =  getFederateName(params, "FLIGHT_DYNAMICS");
	...
	std::wstring FederationName = FlightDynamicsFederateHla13::getWString(federationName.c_str());
	std::wstring FederateName = FlightDynamicsFederateHla13::getWString(federateName.c_str());
	std::wstring FomFile = FlightDynamicsFederateHla13::getWString(fomFile.c_str());
	...
	FlightDynamicsFederateHla13 myFederate(FederationName, FederateName, FomFile);
