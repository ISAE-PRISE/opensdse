...
class FlightDynamicsFederateHla1516e : public rti1516e::NullFederateAmbassador, public UnitConversion 
{
	// Private  elements
	private:
		...
		rti1516e::ObjectInstanceHandle _TRIM_DATA_ObjectHandle;
		...
		rti1516e::AttributeHandle _RIGHT_ENGINE_THRUST_EQ_ATTRIBUTE, 
		...
		//std::unique_ptr<rti1516e::AttributeHandleValuePairSet> ahvps_TRIM_DATA;
		//std::unique_ptr<rti1516e::AttributeHandleValuePairSet> ahvps_AIRCRAFT_POSITION;
		//std::unique_ptr<rti1516e::AttributeHandleValuePairSet> ahvps_AIRCRAFT_ORIENTATION;
		//std::unique_ptr<rti1516e::AttributeHandleValuePairSet> ahvps_AIRCRAFT_UVW_SPEED;
		//std::unique_ptr<rti1516e::AttributeHandleValuePairSet> ahvps_AIRCRAFT_PQR_ANGULAR_SPEED;
		//std::unique_ptr<rti1516e::AttributeHandleValuePairSet> ahvps_AIRCRAFT_ACCELERATION;
		//std::unique_ptr<rti1516e::AttributeHandleValuePairSet> ahvps_AIRCRAFT_SPEED;
		//std::unique_ptr<rti1516e::AttributeHandleValuePairSet> ahvps_AIRCRAFT_ADDITIONAL;
	...
	public:
        ...
        void sendUpdateAttributes1(RTI1516fedTime UpdateTime);
        void sendUpdateAttributes2(RTI1516fedTime UpdateTime);
		void run();  
		void runOneStep();                                       
		void pauseInitTrim();
		void pauseInitSim();
